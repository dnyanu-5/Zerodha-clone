    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        ...
        <div className="row mb-4">
          <div className="col fs-6 m-3">
            <a href="" className="text-muted mx-2" style={{ textDecoration: "none" }}>NSE</a>
            <a href="" className="text-muted mx-2" style={{ textDecoration: "none" }}>BSE</a>
            <a href="" className="text-muted mx-2" style={{ textDecoration: "none" }}>MCX</a>
            <a href="" className="text-muted mx-2" style={{ textDecoration: "none" }}>Terms & conditions</a>
            <a href="" className="text-muted mx-2" style={{ textDecoration: "none" }}>Policies & procedures</a>
            <a href="" className="text-muted mx-2" style={{ textDecoration: "none" }}>Privacy policy</a>
            <a href="" className="text-muted mx-2" style={{ textDecoration: "none" }}>Disclosure</a>
            <a href="" className="text-muted mx-2" style={{ textDecoration: "none" }}>For investor's attention</a>
            <a href="" className="text-muted mx-2" style={{ textDecoration: "none" }}>Investor charter</a>
          </div>
        </div>
